...
Builder.prototype = {
  ...
  hide: function () {
    ...
    document.querySelectorAll('.medium-editor-table-builder').forEach(item => item.style.display = 'none');
  ...
  show: function (left) {
    /* weird fix */
     document.querySelectorAll('.medium-editor-table-builder').forEach(item => item.style.display = 'block');
    /* end */
